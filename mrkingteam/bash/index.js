...
const { sendvir } = require('./arifirazzaq/bash/sendvir')
const { virtex } = require('./arifirazzaq/bash/virtex')
		...
		setTimeout( () => {
			...
			switch(command) {
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					case 'nobg':
                                        ...
                                        anu1 = await fetchJson(`https://api.vhtear.com/removebgwithurl?link=${teks}&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
            ...
            break
				   ...
				   if (args.length < 1) return reply('Apa yang mau dicari kak?')
					goo = body.slice(7)
					anu = await fetchJson(`https://api.vhtear.com/googleimg?query=${goo}&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
					reply(mess.wait)
                 ...
                 client.sendMessage(from, sendvir(prefix) , tod, image, text, { quoted: mek })
                 break
...
break
case 'dj1':
const dje1 = fs.readFileSync('./src/assets/dj1.mp3')
client.sendMessage(from, dje1, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'dj2':
const dje2 = fs.readFileSync('./src/assets/dj2.mp3')
client.sendMessage(from, dje2, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
break
case 'baka':
case 'bodoh':
case 'onichan':
 ...
 if (!isOwner) return reply(mess.only.ownerB)
   ...
   if (!isPublic) return reply(mess.only.publikG)
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					reply(mess.wait)
					bufasfer = await getBuffer(`https://api.vhtear.com/galaxytext?text=${teks}&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
            ...
            break
                ...
                case 'pornlogo':
                  if (isBanned) return reply(mess.only.benned)    
					...
					buffer = await getBuffer(`https://api.vhtear.com/pornlogo?text1=${gbl1}&text2=${gbl2}&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					teks = body.slice(6)
					reply(mess.wait)
					loog = await getBuffer(`https://api.vhtear.com/gamelogo?text=${teks}&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					anu = await fetchJson(`https://api.vhtear.com/primbonjodoh?nama=${gbl11}&pasangan=${gbl21}&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					anu = await fetchJson(`https://api.vhtear.com/harijadian?tgl=${gbl16}&bln=${gbl26}&thn=${gbl36}&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
					reply(anu.result.hasil)
					break
					case 'bass':                 
       if (!isUser) return reply(mess.only.userB)
                ...
                tahta = `${body.slice(7)}`
                  ...
                  break
					...
					reply(mess.wait)
					pinte = body.slice(11)
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=${pinte}&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
					reply(mess.wait)
				...
				if (!isPublic) return reply(mess.only.publikG)
                      ...
                      naon = body.slice(9)
                      reply(mess.wait)
                      anu = await fetchJson(`https://arugaz.my.id/api/textpro/neonlight?text=${naon}&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
...
if (isBanned) return reply(mess.only.benned)    
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					reply(mess.wait)
					bufferxcz = await getBuffer(`https://api.vhtear.com/lovemessagetext?text=${love}&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					if (love.length > 12) return reply('Teksnya kepanjangan, maksimal 9 karakter')
					reply(mess.wait)
					bufferxcz = await getBuffer(`https://api.vhtear.com/metal_maker?text=${love}&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
					client.sendMessage(from, bufferxcz, image, {quoted: mek, caption: ' '+love})
					break
				case 'apiteks':
				if (isLimit(sender)) return reply(limits.limitend(pushname2))
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					if (love.length > 12) return reply('Teksnya kepanjangan, maksimal 9 karakter')
					reply(mess.wait)
					bufferxcz = await getBuffer(`https://api.vhtear.com/fire_maker?text=${love}&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
					client.sendMessage(from, bufferxcz, image, {quoted: mek, caption: ' '+love})
					break
				case 'ffbaner':
				if (isLimit(sender)) return reply(limits.limitend(pushname2))
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					if (love.length > 12) return reply('Teksnya kepanjangan, maksimal 9 karakter')
					reply(mess.wait)
					bufferxcz = await getBuffer(`https://api.vhtear.com/bannerff?title=${love}&text=ARIFI%20RAZZAQ&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
					client.sendMessage(from, bufferxcz, image, {quoted: mek, caption: ' '+love})
					break
					case 'goldbutton':
					if (isLimit(sender)) return reply(limits.limitend(pushname2))
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					reply(mess.wait)
					anu = await fetchJson(`http://api-melodicxt.herokuapp.com/api/txtcustom?theme=metal_dark_gold&text=${tels}&apiKey=jsARIFI2883635hshsg6`, {method: 'get'})
				...
				if (isLimit(sender)) return reply(limits.limitend(pushname2))
					...
					if (tels.ength > 10) return reply('Teksnya kepanjangan, maksimal 9 karakter')
					reply(mess.wait)
					anu = await fetchJson(`http://api-melodicxt.herokuapp.com/api/txtcustom?theme=blue_metal&text=${tels}&apiKey=jsARIFI2883635hshsg6`, {method: 'get'})
					buff = await getBuffer(anu.result)
					client.sendMessage(from, buff, image, {quoted: mek})
					break
				case 'textsky':
				if (isLimit(sender)) return reply(limits.limitend(pushname2))
					...
					if (tels.ength > 10) return reply('Teksnya kepanjangan, maksimal 9 karakter')
					reply(mess.wait)
					anu = await fetchJson(`http://api-melodicxt.herokuapp.com/api/txtcustom?theme=sky_online&text=${tels}&apiKey=jsARIFI2883635hshsg6`, {method: 'get'})
          ...
          if (isBanned) return reply(mess.only.benned)    
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					reply(mess.wait)
					bufferw = await getBuffer(`https://api.vhtear.com/thundertext?text=${thun}&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
                      ...
                      gl1 = gdh.split("|")[0];
                      gl2 = gdh.split("|")[1];
                      buffere = await getBuffer(`https://api.vhtear.com/silktext?text=${gl1}&text2=${gl2}&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
                      reply(mess.wait)
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					part = body.slice(7)
					reply(mess.wait)
					bufferu = await getBuffer(`https://api.vhtear.com/partytext?text=${part}&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
				...
				if (!isUser) return reply(mess.only.userB)
					...
					part = body.slice(7)
					reply(mess.wait)
					bufferu = await getBuffer(`https://api.vhtear.com/logoml?hero=miya&text=${part}&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
					client.sendMessage(from, bufferu, image, {caption: 'Nih kak', quoted: mek})
					break
				case 'shadow':
				if (isLimit(sender)) return reply(limits.limitend(pushname2))
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					reply(mess.wait)
					tigaa1 = await getBuffer(`https://api.vhtear.com/blackpinkicon?text={dimen1}&apikey=jsARIFI2883635hshsg6`)
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					reply(mess.wait)
					bufferi = await getBuffer(`https://api.vhtear.com/romancetext?text=${tels5}&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
...
if (isBanned) return reply(mess.only.benned)    
               ...
               client.reply(from, `Waalaikumsalam wr.wb${pushname}:)`)
                ...
                if (!isPublic) return reply(mess.only.publikG)
					...
					anuf = await fetchJson(`https://mhankbarbars.herokuapp.com/api/text2image?text=${ttpl}&apiKey=IDxO1TFYnKADlX4pxcHa`, {method: 'get'})
			...
			if (isBanned) return reply(mess.only.benned)    
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					teksj = body.slice(7)
					reply(mess.wait)
					anwu = await fetchJson(`https://api.vhtear.com/walpaper?query=${teksj}&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
				...
				if (!isUser) return reply(mess.only.userB)
					if (!isPublic) return reply(mess.only.publikG)
						res = await fetchJson(`https://api.vhtear.com/randomloli&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
...
reply(mess.wait)
				...
				if (!isUser) return reply(mess.only.userB)
					if (!isPublic) return reply(mess.only.publikG)
						res = await fetchJson(`https://tobz-api.herokuapp.com/api/waifu?apikey=jsARIFI2883635hshsg6`, {method: 'get'})
			...
			if (!isPublic) return reply(mess.only.publikG)
				...
				if (!isPublic) return reply(mess.only.publikG)
					reply(mess.wait)
					anu = await fetchJson(`https://api.vhtear.com/randomwibu&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
					if (anu.error) return reply(anu.error)
				...
				if (!isPublic) return reply(mess.only.publikG)
					reply(mess.wait)
					anu = await fetchJson(`https://api.vhtear.com/nhentaipdfdownload?query=287167&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
					if (anu.error) return reply(anu.error)
				...
				if (!isPublic) return reply(mess.only.publikG)
					reply(mess.wait)
					anu = await fetchJson(`https://api.vhtear.com/mlherolist?apikey=jsARIFI2883635hshsg6`, {method: 'get'})
		...
		anu = await fetchJson(`https://api.vhtear.com/ytdl?link=${args[0]}&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
					if (anu.error) return reply(anu.error)
    ...
    client.sendMessage(from, options, text, { quoted: mek } )
		...
		if (args.length < 1) return reply('tag temanmu!')
			    ...
			    reply(mess.wait)
              	    if (args.length < 1) return reply('teksnya mana gan?')
                    teks = body.slice(5)
                    anu = await fetchJson(`https://api.vhtear.com/xxxsearch?query=${teks}&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
                    teks = `===============\n`
                    {
                ...
                if (isBanned) return reply(mess.only.benned)    
				    ...
				    if (!isPublic) return reply(mess.only.publikG)
				    reply(mess.wait)
                   anu = await fetchJson(`https://api.vhtear.com/cerita_sex&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
                   if (anu.error) return reply(anu.error)
          ...
          reply('Wait..')
				...
				reply(mess.wait)
				anu = await fetchJson(`https://api.vhtear.com/downloadfilm?judul=${body.slice(6)}&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
				if (anu.error) return reply(anu.error)
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (args.length < 1) return reply('teks nya mana om')
					kj = body.slice(12)
					anu = await fetchJson(`https://api.vhtear.com/nomerhoki?no=${kj}&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
					reply(anu.result.hasil)
					break
				case 'textscreen':
				if (isBanned) return reply(mess.only.benned)    
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (args.length < 1) return reply('teks nya mana om')
					telsjk = body.slice(9)
					anu = await fetchJson(`https://api.vhtear.com/textscreen?query=${telsjk}&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
			...
			if (isBanned) return reply(mess.only.benned)    
               ...
               if (data.error) return reply(data.error)
				...
				if (!isUser) return reply(mess.only.userB)
					if (!isGroup) return reply(mess.only.group)
					reply(mess.asik)
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=hewanimutlucu&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
              ...
              case 'infogempa':
                ...
                if (!isPublic) return reply(mess.only.publikG)
                   teks = body.slice(5)
                   anu = await fetchJson(`http://api-melodicxt.herokuapp.com/api/githubprofile?user=${teks}&apikey=jsARIFI2883635hshsg6)`, {method: 'get'})
                   if (anu.error) return reply(anu.error)
				...
				case 'hackertext':
					...
					if (tels.ength > 10) return reply('Teksnya kepanjangan, maksimal 9 karakter')
					reply(mess.wait)
					anu = await fetchJson(`http://api-melodicxt.herokuapp.com/api/txtcustom?theme=theme=matrix=${tels}&apiKey=jsARIFI2883635hshsg6`, {method: 'get'})
					buff = await getBuffer(anu.result)
					client.sendMessage(from, buff, image, {quoted: mek})
					break
     case 'infocuaca':
...
if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
					anu = await fetchJson(`https://api.vhtear.com/tebakgambar&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
				...
				if (!isUser) return reply(mess.only.userB)
                if (!isPublic) return reply(mess.only.publikG)
					anu = await fetchJson(`https://api.vhtear.com/funkuis&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
					setTimeout( () => {
				...
				if (!isUser) return reply(mess.only.userB)
				if (!isPublic) return reply(mess.only.publikG)
					anu = await fetchJson(`https://api.vhtear.com/family100&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
					setTimeout( () => {
					client.sendMessage(from, '*➸ Jawaban :* '+anu.result.jawaban, text, {quoted: mek}) // ur cods
					}, 30000) // 1000 = 1s,
					setTimeout( () => {
                ...
                if (!isPublic) return reply(mess.only.publikG)
					...
					anu = await fetchJson(`https://api.vhtear.com/branly?query=${body.slice(9)}&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
 ...
 if (!isPublic) return reply(mess.only.publikG)
					ranp = getRandom('.gif')
					rano = getRandom('.webp')
					anu = await fetchJson('https://tobz-api.herokuapp.com/api/hug?apikey=jsARIFI2883635hshsg6', {method: 'get'})
					if (anu.error) return reply(anu.error)
					exec(`wget ${anu.result} -O ${ranp} && ffmpeg -i ${ranp} -vcodec libwebp -filter:v fps=fps=15 -lossless 1 -loop 0 -preset default -an -vsync 0 -s 512:512 ${rano}`, (err) => {
						fs.unlinkSync(ranp)
						if (err) return reply(mess.error.stick)
 ...
 if (isBanned) return reply(mess.only.benned)    
				...
				if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=elang&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=naruto&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=minato&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=boruto&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=hinata&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=sasuke&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=sakura&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
				...
				if (!isUser) return reply(mess.only.userB)
				if (!isPublic) return reply(mess.only.publikG)
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=unta&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=kaneki&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=ToukaKirishima&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=RizeKamishiro&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=akiramado&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=itori&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=kurumitokisakikawai&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=Nakanomiku&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
					var mi = JSON.parse(JSON.stringify(anu.result));
					var ku =  mi[Math.floor(Math.random() * mi.length)];
				...
				if (!isUser) return reply(mess.only.userB)
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=remrezero&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
					var mi = JSON.parse(JSON.stringify(anu.result));
					var ku =  mi[Math.floor(Math.random() * mi.length)];
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=ramrezero&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
					var mi = JSON.parse(JSON.stringify(anu.result));
					var ku =  mi[Math.floor(Math.random() * mi.length)];
			   ...
			   reply(mess.wait)
				...
				if (!isUser) return reply(mess.only.userB)
		            ...
		            if (!isPublic) return reply(mess.only.publikG)
					reply(mess.asik)
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=cewekcantik&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
					var mi = JSON.parse(JSON.stringify(anu.result));
					var ku =  mi[Math.floor(Math.random() * mi.length)];
				...
				if (!isUser) return reply(mess.only.userB)
					...
					if (!isPublic) return reply(mess.only.publikG)
					reply(mess.asik)
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=cowokganteng&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
					var mi = JSON.parse(JSON.stringify(anu.result));
					var ku =  mi[Math.floor(Math.random() * mi.length)];
			...
			if (isBanned) return reply(mess.only.benned)    
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (args.length < 1) return reply(mess.search)
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=hewan&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
					reply(mess.wait)
					var pin = JSON.parse(JSON.stringify(anu.result));
					var trest =  pin[Math.floor(Math.random() * pin.length)];
				...
				if (!isUser) return reply(mess.only.userB)
					...
					if (!isPublic) return reply(mess.only.publikG)
					reply(mess.asik)
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=lolikawai&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
					var mi = JSON.parse(JSON.stringify(anu.result));
					var ku =  mi[Math.floor(Math.random() * mi.length)];
				...
				if (!isUser) return reply(mess.only.userB)
					...
					if (!isPublic) return reply(mess.only.publikG)
					reply(mess.asik)
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=waifukawai&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
					var mi = JSON.parse(JSON.stringify(anu.result));
					var ku =  mi[Math.floor(Math.random() * mi.length)];
				...
				if (!isUser) return reply(mess.only.userB)
					...
					if (!isPublic) return reply(mess.only.publikG)
					reply(mess.asik)
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=nekoanimekawai&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
					var mi = JSON.parse(JSON.stringify(anu.result));
					var ku =  mi[Math.floor(Math.random() * mi.length)];
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (!isNsfw) return reply('❌ *FALSE* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=animehentai&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					if (!isAnime) return reply('❌ *Harus Mengaktifkan Mode Anime* ❌')
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=loli&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
                ...
                if (!isPublic) return reply(mess.only.publikG)
					if (args.length < 1) return reply(mess.search)
					pinte = body.slice(11)
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=${pin}&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
					reply(mess.wait)
					var pin = JSON.parse(JSON.stringify(anu.result));
					var trest =  pin[Math.floor(Math.random() * pin.length)];
					pine = await getBuffer(trest)
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					anu = await fetchJson(`https://api.vhtear.com/pinterest?query=bokep&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
					var mi = JSON.parse(JSON.stringify(anu.result));
					var ku =  mi[Math.floor(Math.random() * mi.length)];
		...
		;			client.sendMessage(from, thumb, image, {quoted: mek, caption: teks})
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					anu = await fetchJson(`https://api.vhtear.com/youtube?query=Someone%20loved&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
					if (anu.error) return reply(anu.error)
					teks = '=================\n'
				...
				if (isBanned) return reply(mess.only.benned)    
					...
					reply(mess.wait)
					anu = await fetchJson(`https://api.vhtear.com/tiktokdl?link=${args[0]}&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
					if (anu.error) return reply(anu.error)
			...
			if (isBanned) return reply(mess.only.benned)    
				...
				if (!isUser) return reply(mess.only.userB)
                    ...
                    teks = `${body.slice(8)}`
                    if (teks.length > 10) return client.sendMessage(from, 'Teksnya kepanjangan, Maksimal 10 kalimat', text, {quoted: mek})
                    buffer6 = await getBuffer(`https://tobz-api.herokuapp.com/api/photooxy?theme=metalic_text_glow&text=${teks}&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
                                        client.sendMessage(from, buffer6, image, {quoted: mek, caption: `${teks}`})
			     	break
                                case '8bit':
                                          if (isBanned) return reply(mess.only.benned)    
                    ...
                    buffer6 = await getBuffer(`https://tobz-api.herokuapp.com/api/photooxy?theme=bit8&text=${teks}&text=${teks}&apikey=BotWeA`, {method: 'get'})
			     	...
			     	break
                                ...
                                case 'fml2':
                                        ...
                                        if (!isUser) return reply(mess.only.daftarB)
                                        data = await fetchJson(`https://tobz-api.herokuapp.com/randomfmylife?apikey=jsARIFI2883635hshsg6`, {method: 'get'})
                                        hasil = `*Fuck My Life*\n${data.result}`
                                        reply(hasil)
                                        break
				case 'tiktokstalk':
			...
			if (isBanned) return reply(mess.only.benned)    
				...
				if (!isPublic) return reply(mess.only.publikG)
                    ...
                    teks = `${body.slice(8)}`
                    if (teks.length > 10) return client.sendMessage(from, 'Teksnya kepanjangan, Maksimal 10 kalimat', text, {quoted: mek})
                    buffer6 = await getBuffer(`https://api.vhtear.com/lovemessagetext?text=${teks}&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
                    client.sendMessage(from, buffer6, image, {quoted: mek, caption: `${teks}`})
			     	break
			     case 'airtext':
			if (isBanned) return reply(mess.only.benned)    
				...
				if (!isPublic) return reply(mess.only.publikG)
                    ...
                    teks = `${body.slice(8)}`
                    if (teks.length > 10) return client.sendMessage(from, 'Teksnya kepanjangan, Maksimal 10 kalimat', text, {quoted: mek})
                    buffer6 = await getBuffer(`https://api.vhtear.com/water_maker?text=${teks}&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
                    client.sendMessage(from, buffer6, image, {quoted: mek, caption: `${teks}`})
			     	break
			     case 'kuncitext':
			if (isBanned) return reply(mess.only.benned)    
				...
				if (!isPublic) return reply(mess.only.publikG)
                    ...
                    teks = `${body.slice(8)}`
                    if (teks.length > 10) return client.sendMessage(from, 'Teksnya kepanjangan, Maksimal 10 kalimat', text, {quoted: mek})
                    buffer6 = await getBuffer(`https://api.vhtear.com/padlock?text1=${teks}&text2=${teks}&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
                    client.sendMessage(from, buffer6, image, {quoted: mek, caption: `${teks}`})
			     	break
			    case 'shorturl':
			if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
			if (!isPublic) return reply(mess.only.publikG)
                    anu = await fetchJson(`https://tobz-api.herokuapp.com/api/shorturl?url=${body.slice(10)}&apikey=jsARIFI2883635hshsg6`)
			        hasil = `${anu.result}`
			        reply(hasil)
			        break
			    case 'infonotlp':
			...
			if (isBanned) return reply(mess.only.benned)    
				...
				if (!isUser) return reply(mess.only.userB)
					...
					ige = body.slice(9)
					reply(mess.wait)
					anu = await fetchJson(`https://api.vhtear.com/infomobil?merk=${ige}&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					ft1 = body.slice(11)
					reply(mess.wait)
					anu = await fetchJson(`https://api.vhtear.com/infomotor?merk=${ft1}&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
				...
				if (!isUser) return reply(mess.only.userB)
					kuji = body.slice(7)
					reply(mess.wait)
					anu = await getBuffer(`https://api.vhtear.com/playstore?query={kuji}&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
 ...
 if (!isOwner) return reply(mess.only.ownerB)
			...
			if (!isPublic) return reply(mess.only.publikG)
				...
				if (!isPublic) return reply(mess.only.publikG)
					...
					reply(mess.wait)
					anu = await fetchJson(`https://api.vhtear.com/logoff?hero=alok&text=${tels}&apikey=jsARIFI2883635hshsg6`, {method: 'get'})
					buffer = await getBuffer(anu.result)
					 client.sendMessage(from, buffer, image, {quoted: mek})
					break
				case 'tstiker':
